...
**Status**: v0.0.9. 18 packages, 1200+ tests. NopeCHA CAPTCHA extension auto-downloads on first launch. Only issue #27 (SERP docs), #29 (leech/seed), #34 (proxy intelligence) remain open.
